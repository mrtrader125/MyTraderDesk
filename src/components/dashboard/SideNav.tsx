...
export default function SideNav() {
  ...
  return (
    <aside className={`${isOpen ? 'w-64' : 'w-20'} transition-all duration-300 border-r border-neutral-200 dark:border-card-border bg-white dark:bg-card-bg shadow-md dark:shadow-card flex flex-col h-screen shrink-0 z-50`}>
      
      {/* BRANDING & TOGGLE */}
      <div className="h-16 flex items-center px-4 border-b border-neutral-200 dark:border-card-border justify-between overflow-hidden">
        {isOpen && (
      ...
      {/* DISCONNECT / LOGOUT */}
      <div className="p-4 border-t border-neutral-200 dark:border-card-border">
        <button 
