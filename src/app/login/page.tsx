...
import { Loader2, Lock, Mail, ChevronRight, AlertTriangle, Send, CheckCircle2 } from 'lucide-react'
...
export default function LoginPage() {
  ...
  // 🚨 NEW: States for Email Verification Handling
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      // 🚨 FIX: Catch the specific "unverified email" error from Supabase
