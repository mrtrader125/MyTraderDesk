                    ...
                    >
                      <td className="p-5">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-black text-neutral-900 dark:text-white">{user.full_name || 'Unknown User'}</p>
            ...
            <div className="p-6 border-b border-neutral-200 dark:border-neutral-800 flex items-start justify-between bg-neutral-50 dark:bg-[#050505]">
              <div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-neutral-900 dark:text-white">{selectedUser.full_name || 'Unknown User'}</h3>
              ...
              <button onClick={() => setSelectedUser(null)} className="p-2 text-neutral-500 hover:text-neutral-900 dark:text-white bg-neutral-900 rounded-full transition-colors">
                <X size={16} />
              </button>
            </div>
                  ...
                  <div className="space-y-3">
                    {userActivity.length === 0 ? (
                      ...
                      userActivity.map(log => {
                        ...
                        if (log.action === 'SEARCH') { actionColor = "text-neutral-900 dark:text-white"; actionText = "Searched"; Icon = Search }
