...
import { Search, Shield, Crown, Zap, Activity, ChevronRight, X, User, Clock, AlertTriangle, Target, BarChart2 } from 'lucide-react'
                        ...
                        return (
                          <div key={log.id} className="flex items-start space-x-3 p-3 bg-[#050505] rounded-xl border border-neutral-800/50">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-[8px] font-black text-neutral-600 mt-1">
