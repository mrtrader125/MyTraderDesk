  ...
  return (
    <div className="max-w-screen-2xl mx-auto space-y-6 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <button 
        ...
        className="flex items-center text-[10px] font-black uppercase tracking-widest text-neutral-500 hover:text-neutral-900 dark:text-white transition-colors"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 bg-white dark:bg-card-bg shadow-md dark:shadow-card border border-neutral-200 dark:border-card-border rounded-3xl overflow-hidden shadow-2xl relative flex flex-col">
          ...
          <div className="p-4 border-t border-neutral-200 dark:border-card-border bg-white dark:bg-card-bg shadow-md dark:shadow-card flex items-center justify-between">
            ...
            <button 
              ...
              className="flex items-center text-[9px] font-black text-neutral-400 hover:text-neutral-900 dark:text-white uppercase tracking-widest transition-colors"
            >
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white dark:bg-card-bg shadow-md dark:shadow-card border border-neutral-200 dark:border-card-border rounded-3xl p-6 shadow-xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className={`inline-flex items-center px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest border shadow-sm ${isBull ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-500' : isBear ? 'bg-red-500/10 border-red-500/20 text-red-500' : 'bg-neutral-800 border-neutral-700 text-neutral-900 dark:text-white'}`}>
              ...
              <div>
                ...
                <div className="flex items-center text-sm font-black text-neutral-900 dark:text-white">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center py-4 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-neutral-900 dark:text-white border border-red-500/20 hover:border-red-500 text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all shadow-lg"
          >
