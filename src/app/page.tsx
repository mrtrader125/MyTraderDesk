...
const HoverRevealSlider = ({ before, after }: { before: string, after: string }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className={`absolute bottom-4 right-4 bg-[#050505]/90 backdrop-blur-md px-4 py-2 rounded-lg text-[10px] font-bold text-emerald-400 uppercase tracking-widest transition-all duration-[800ms] ease-[cubic-bezier(0.16,1,0.3,1)] z-0 ring-1 ring-white/[0.05] ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
        Result
      </div>
      <div 
      ...
      >
        ...
        />
        <div className={`absolute bottom-4 left-4 bg-[#050505]/90 backdrop-blur-md px-4 py-2 rounded-lg text-[10px] font-bold text-neutral-300 uppercase tracking-widest transition-all duration-500 ring-1 ring-white/[0.05] ${isHovered ? 'opacity-0' : 'opacity-100'}`}>
          Initial Setup
        </div>
      </div>
      <div 
...
<section id="features" className="relative z-10 w-full py-24 lg:py-28 px-6 border-t border-neutral-900 bg-[#020202]">
  <div className="max-w-[1400px] mx-auto">
    ...
    <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
      ...
      {/* CARD 1 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <Workflow className="w-7 h-7 text-blue-500 mb-5" />
        
        <div className="mb-3">
          <h3 className="text-lg font-bold text-white">
            MT5 Data Sync
          </h3>
          <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-600 font-bold mt-1">
            Execution Infrastructure
          </p>
        </div>

        <p className="text-sm text-neutral-400 leading-relaxed">
          Connect your broker data via CSV or HTML parsing. Matches live executions to drafted setups, creating a frictionless trading record.
        </p>
      </div>

      {/* CARD 2 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <BookOpen className="w-7 h-7 text-emerald-500 mb-5" />
        ...
        <p className="text-sm text-neutral-400 leading-relaxed">
          Go beyond PnL. Track execution quality, emotional discipline, and behavioral mistakes while assigning measurable costs to inconsistency.
        </p>
      </div>

      {/* CARD 3 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <TerminalSquare className="w-7 h-7 text-purple-500 mb-5" />
        ...
        <p className="text-sm text-neutral-400 leading-relaxed">
          Access institutional-grade structural analysis, directional bias, and key invalidation zones before executing your own setups.
        </p>
      </div>

      {/* CARD 4 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <ShieldCheck className="w-7 h-7 text-cyan-500 mb-5" />
        ...
        <p className="text-sm text-neutral-400 leading-relaxed">
          Build a personalized execution system around your existing strategy and edge to reduce mental overload, impulsive trades, and excessive chart exposure.
        </p>
      </div>

      {/* CARD 5 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <Map className="w-7 h-7 text-amber-500 mb-5" />
        ...
        <div className="mb-3">
          ...
          <p className="text-[10px] uppercase tracking-[0.2em] text-neutral-600 font-bold mt-1">
            Professional Structural Guidance
          </p>
        </div>

        <p className="text-sm text-neutral-400 leading-relaxed">
          Receive higher-timeframe market structure, directional perspectives, and execution context designed to support independent decision-making.
        </p>
      </div>

      {/* CARD 6 */}
      <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-7 hover:border-neutral-700 transition-all duration-300 shadow-lg shadow-black/20">
        <Activity className="w-7 h-7 text-rose-500 mb-5" />
        ...
        <p className="text-sm text-neutral-400 leading-relaxed">
          Identify emotional execution problems such as FOMO, hesitation, revenge trading, and impulsive behavior while improving long-term discipline over time.
        </p>
      </div>
      ...
      <section id="blueprint" className="relative z-10 w-full py-24 lg:py-32 px-6 overflow-hidden border-t border-neutral-900 bg-[#050505]">
        ...
        <div className="relative max-w-4xl mx-auto px-2 sm:px-0">
          <div className="absolute top-4 bottom-4 left-[31px] md:left-1/2 w-px bg-neutral-800/80 md:-translate-x-[0.5px] z-0"></div>

          <div className="space-y-10 md:space-y-16 relative z-10">
            <div className="relative flex flex-col md:flex-row items-center w-full">
              <div className="absolute left-[22px] md:hidden w-4 h-4 rounded-full bg-blue-500 ring-4 ring-[#050505] z-10"></div>
              ...
              <div className="w-full md:w-1/2 pl-14 md:pl-0 md:pr-12 relative">
                ...
                <Link href="/protocol/identity" className="block bg-[#080808] p-6 lg:p-8 rounded-2xl border border-neutral-800/60 hover:border-blue-500/50 transition-all hover:-translate-y-1 group shadow-lg shadow-black/20">
                  <User className="w-6 h-6 mb-4 text-blue-500 group-hover:scale-110 transition-transform" />
                  <h3 className="text-sm font-bold mb-2 text-white">1. The Identity</h3>
                  <p className="text-neutral-400 text-xs leading-relaxed font-medium">Discover why intermediate traders stay unprofitable and the required mindset shift.</p>
                </Link>
              </div>
            ...
            <div className="relative flex flex-col md:flex-row items-center w-full">
              <div className="absolute left-[22px] md:hidden w-4 h-4 rounded-full bg-cyan-500 ring-4 ring-[#050505] z-10"></div>
              ...
              <div className="w-full md:w-1/2 pl-14 md:pl-12 relative">
                ...
                <Link href="/protocol/strategy" className="block bg-[#080808] p-6 lg:p-8 rounded-2xl border border-neutral-800/60 hover:border-cyan-500/50 transition-all hover:-translate-y-1 group shadow-lg shadow-black/20">
                  <Map className="w-6 h-6 mb-4 text-cyan-500 group-hover:scale-110 transition-transform" />
                  <h3 className="text-sm font-bold mb-2 text-white">2. The Strategy</h3>
                  <p className="text-neutral-400 text-xs leading-relaxed font-medium">Strategy isn't magic; it's finding your place in the market's endless journey.</p>
                </Link>
              </div>
            </div>

            <div className="relative flex flex-col md:flex-row items-center w-full">
              <div className="absolute left-[22px] md:hidden w-4 h-4 rounded-full bg-emerald-500 ring-4 ring-[#050505] z-10"></div>
              ...
              <div className="w-full md:w-1/2 pl-14 md:pl-0 md:pr-12 relative">
                <div className="hidden md:block absolute right-0 top-1/2 w-8 h-px bg-neutral-800 -z-10"></div>
                <Link href="/protocol/system" className="block bg-[#080808] p-6 lg:p-8 rounded-2xl border border-neutral-800/60 hover:border-emerald-500/50 transition-all hover:-translate-y-1 group shadow-lg shadow-black/20">
                  <ShieldCheck className="w-6 h-6 mb-4 text-emerald-500 group-hover:scale-110 transition-transform" />
                  <h3 className="text-sm font-bold mb-2 text-white">3. The System</h3>
                  <p className="text-neutral-400 text-xs leading-relaxed font-medium">Bridging the gap between theory and execution to build an edge you can actually follow.</p>
                </Link>
              </div>
              <div className="hidden md:block w-1/2"></div>
            </div>
            ...
            <div className="relative flex flex-col md:flex-row items-center w-full">
              <div className="absolute left-[22px] md:hidden w-4 h-4 rounded-full bg-purple-500 ring-4 ring-[#050505] z-10"></div>
              ...
              <div className="w-full md:w-1/2 pl-14 md:pl-12 relative">
                <div className="hidden md:block absolute left-0 top-1/2 w-8 h-px bg-neutral-800 -z-10"></div>
                <Link href="/protocol/routine" className="block bg-[#080808] p-6 lg:p-8 rounded-2xl border border-neutral-800/60 hover:border-purple-500/50 transition-all hover:-translate-y-1 group shadow-lg shadow-black/20">
                  <Filter className="w-6 h-6 mb-4 text-purple-500 group-hover:scale-110 transition-transform" />
                  <h3 className="text-sm font-bold mb-2 text-white">4. The Routine</h3>
                  <p className="text-neutral-400 text-xs leading-relaxed font-medium">The 3-Level Filtration process. Narrow the market down to high-probability executions.</p>
                </Link>
              </div>
            </div>
          </div>
              ...
              return (
                <div key={item.id} onClick={() => { if(!isActive) setActiveFeaturedSlide(index) }} className={`absolute w-[90%] sm:w-[75%] md:w-[65%] lg:w-[55%] xl:w-[48%] p-4 sm:p-5 bg-[#080808] transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] rounded-3xl overflow-hidden flex flex-col ${styleClass}`}>
                  ...
                  {item.after_image_url && item.image_url ? (
                    ...
                    <div className="rounded-2xl w-full aspect-video bg-[#050505] ring-1 ring-white/[0.04] flex items-center justify-center shadow-inner"><BarChart3 className="text-neutral-800 w-8 h-8" /></div>
                  )}
                </div>
              );
            })}
      ...
      <section className="relative z-10 w-full py-24 lg:py-32 px-6 border-t border-neutral-900 bg-[#020202]">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-[1200px] mx-auto">
          <div className="bg-[#080808] border border-neutral-800/60 rounded-2xl p-8 relative flex flex-col justify-between shadow-lg shadow-black/10">
      ...
      <section className="relative z-10 w-full py-24 lg:py-32 px-6 border-t border-neutral-900 bg-[#050505]">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-[1000px] mx-auto">
          <div className="bg-[#080808] p-8 lg:p-10 rounded-2xl border border-emerald-500/20 shadow-lg shadow-emerald-900/5">
          ...
          <div className="bg-[#080808] p-8 lg:p-10 rounded-2xl border border-red-500/20 shadow-lg shadow-red-900/5">
...
<section id="pricing" className="relative z-10 w-full py-24 lg:py-32 px-6 bg-[#020202] border-t border-neutral-900">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-[#080808] p-1.5 rounded-xl border border-neutral-800/60 inline-flex shadow-lg w-full sm:w-auto overflow-hidden">
            <button onClick={() => setBillingCycle('monthly')} className={`flex-1 sm:flex-none px-8 py-3 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-colors ${billingCycle === 'monthly' ? 'bg-[#1a1a1a] text-white' : 'text-neutral-500 hover:text-neutral-200'}`}>Monthly</button>
            <button onClick={() => setBillingCycle('annual')} className={`flex-1 sm:flex-none px-8 py-3 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-colors flex justify-center items-center gap-3 ${billingCycle === 'annual' ? 'bg-blue-600 text-white' : 'text-neutral-500 hover:text-neutral-200'}`}>
              Annually <span className="bg-white text-blue-600 px-2 py-0.5 rounded-md text-[9px] hidden sm:inline-block">SAVE</span>
            </button>
          </div>
        </div>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-[#080808] border border-neutral-800/60 rounded-xl overflow-hidden shadow-sm">
                <button onClick={() => setOpenFaq(openFaq === index ? null : index)} className="w-full text-left px-6 py-5 flex items-center justify-between focus:outline-none group">
                  <span className="text-sm font-bold text-neutral-300 group-hover:text-white transition-colors pr-4">{faq.q}</span>
                  <ChevronDown className={`w-5 h-5 text-neutral-600 shrink-0 transition-transform duration-300 ${openFaq === index ? 'rotate-180' : ''}`} />
                </button>
                <div className={`px-6 text-sm font-medium text-neutral-500 leading-relaxed transition-all duration-300 ${openFaq === index ? 'max-h-60 pb-6 opacity-100' : 'max-h-0 opacity-0'}`}>
                  {faq.a}
                </div>
              </div>
            ))}
      ...
      <footer className="w-full bg-[#020202] border-t border-neutral-900 pt-20 pb-10 px-6 md:px-12">
        <div className="max-w-[1600px] 2xl:max-w-[1920px] mx-auto grid grid-cols-2 lg:grid-cols-5 gap-x-8 gap-y-12 mb-16">
          ...
          <div>
            <h4 className="text-neutral-200 text-[10px] font-bold uppercase tracking-widest mb-5">The Blueprint</h4>
            <ul className="space-y-4">
              <li><Link href="/protocol/identity" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Trader vs Operator</Link></li>
              <li><Link href="/protocol/strategy" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Strategy Simplification</Link></li>
              <li><Link href="/protocol/system" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">System Building</Link></li>
              <li><Link href="/protocol/routine" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">The 3-Level Routine</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-neutral-200 text-[10px] font-bold uppercase tracking-widest mb-5">Live Markets</h4>
            <ul className="space-y-4">
              <li><Link href="/analysis/eurusd" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">EUR/USD Analysis</Link></li>
              <li><Link href="/analysis/xauusd" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Gold (XAUUSD) Setups</Link></li>
              <li><Link href="/analysis/btcusd" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Bitcoin (BTC) Structure</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-neutral-200 text-[10px] font-bold uppercase tracking-widest mb-5">Resources</h4>
            <ul className="space-y-4">
              <li><Link href="/playbook" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">The Playbook</Link></li>
              <li><Link href="/faq" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">FAQ</Link></li>
              <li><Link href="/about" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">About Us</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-neutral-200 text-[10px] font-bold uppercase tracking-widest mb-5">Legal</h4>
            <ul className="space-y-4">
              <li><Link href="/terms" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Terms of Service</Link></li>
              <li><Link href="/privacy" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/disclaimer" className="text-xs font-medium text-neutral-500 hover:text-neutral-200 transition-colors">Risk Disclaimer</Link></li>
            </ul>
          </div>
        </div>

        <div className="max-w-[1600px] 2xl:max-w-[1920px] mx-auto border-t border-neutral-800/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[10px] font-bold text-neutral-600 uppercase tracking-widest text-center sm:text-left">
            &copy; {new Date().getFullYear()} Sentinel Vortex. All rights reserved.
          </p>
          <p className="text-[10px] font-bold text-neutral-600 uppercase tracking-widest text-center sm:text-right">
