        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="bg-[#080808] border border-neutral-800 rounded-xl p-8 relative flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 mt-auto">
              ...
              <div>
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest">Operator Name 1</h4>
          ...
          <div className="bg-[#080808] border border-neutral-800 rounded-xl p-8 relative flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 mt-auto">
              ...
              <div>
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest">Operator Name 2</h4>
          ...
          <div className="bg-[#080808] border border-neutral-800 rounded-xl p-8 relative flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 mt-auto">
              ...
              <div>
                <h4 className="text-[11px] font-black text-white uppercase tracking-widest">Operator Name 3</h4>
