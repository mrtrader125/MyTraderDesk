...
import { ArrowRight, User, Map, ShieldCheck, Filter, ChevronLeft, Activity } from 'lucide-react'
    ...
    <div className="bg-[#050505] text-neutral-200 min-h-screen font-sans selection:bg-blue-500/30 selection:text-white">
      ...
      <nav className="w-full border-b border-neutral-900 bg-[#050505] py-4">
        <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
          ...
          <Image src="/logo.png" alt="Sentinel Vortex" width={100} height={24} className="object-contain opacity-50" />
        </div>
      </nav>
