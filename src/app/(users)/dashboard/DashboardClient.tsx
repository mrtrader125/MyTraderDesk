...
export default function DashboardClient() {
  ...
  return (
    <div className="relative flex flex-col h-[calc(100dvh-56px)] md:h-[calc(100dvh-64px)] bg-[#0a0a0a] overflow-hidden w-full">
      ...
      <div className={`relative flex-1 bg-[#0a0a0a] overflow-hidden w-full h-full transition-all duration-1000 ${showOnboarding ? 'opacity-20 blur-sm pointer-events-none' : 'opacity-100 blur-none'}`}>
