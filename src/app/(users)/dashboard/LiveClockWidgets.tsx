...
import { ClockWidgetProps, SessionClockWidgetProps } from './types';
...
const formatTime = (timeStr: string, fontIdx: number) => {
  ...
  return (
    <div className={`flex items-baseline justify-center ${fontStyles[fontIdx]} select-none whitespace-nowrap tabular-nums leading-none`} style={{ fontSize: 'min(13cqi, 40cqb)' }}>
      {parts.map((p, i) => (
