...
import { Key, ShieldCheck, Mail, AlertTriangle, Activity, BadgeCheck, Shield, Loader2 } from 'lucide-react'
...
export default function SecurityPage() {
  ...
  // 1. Send Magic Reset Link via Email (Using your callback logic)
