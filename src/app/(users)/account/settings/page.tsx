...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8 pb-12">
      <div>
        <h2 className="text-xl font-black text-neutral-900 dark:text-neutral-900 dark:text-white uppercase tracking-tight mb-1">Platform Settings</h2>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-5 bg-neutral-50 dark:bg-neutral-50 dark:bg-[#050505] border border-neutral-200 dark:border-neutral-200 dark:border-neutral-800 rounded-2xl">
          ...
          {mounted && (
            <button 
              ...
              className="flex items-center space-x-2 px-4 py-2.5 bg-neutral-100 dark:bg-white/5 border border-neutral-200 dark:border-white/10 rounded-xl text-[10px] font-black text-neutral-600 dark:text-neutral-400 uppercase tracking-widest hover:text-neutral-900 dark:hover:text-neutral-900 dark:text-white transition-all shrink-0"
            >
              {theme === 'dark' ? (
