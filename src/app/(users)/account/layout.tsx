  ...
  return (
    ...
    <div className="w-full bg-[#050505] text-neutral-200 flex flex-col overflow-hidden relative font-sans" style={{ height: 'calc(100dvh - 65px)' }}>
      <div className="max-w-[1800px] mx-auto w-full h-full flex flex-col md:flex-row min-h-0 relative z-10">
        ...
        {/* ========================================= */}
        {/* MOBILE SUB-NAV (Horizontal, Sticky Top)     */}
        {/* ========================================= */}
        <div className="md:hidden shrink-0 w-full bg-[#0a0a0a] border-b border-neutral-900 overflow-x-auto scrollbar-hide px-3 py-3 flex items-center space-x-2 z-20 shadow-sm">
        ...
        {/* ========================================= */}
        {/* 🚨 pb-24 ensures content clears the mobile bottom tab bar */}
        <div className="flex-1 min-w-0 h-full overflow-y-auto custom-scrollbar bg-[#050505] p-4 md:p-8 pb-24 md:pb-8">
