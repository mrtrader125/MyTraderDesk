  ...
  if (isLoading || !data) {
    return (
      <div className="max-w-3xl space-y-6 md:space-y-8 relative">
        <div><div className="h-6 md:h-7 w-40 bg-[#000000] border border-neutral-800 rounded-md animate-pulse mb-2"></div><div className="h-3 w-64 bg-[#000000] border border-neutral-800 rounded-md animate-pulse"></div></div>
        <div className="bg-[#000000] border border-neutral-800 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-sm"><div className="h-4 w-48 bg-neutral-900 rounded animate-pulse mb-5 md:mb-6"></div><div className="space-y-3 md:space-y-4"><div className="flex items-center justify-between gap-4 p-4 md:p-5 bg-[#000000] border border-neutral-800 rounded-xl md:rounded-2xl"><div className="flex-1 space-y-2"><div className="h-3 w-32 bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-full max-w-sm bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-3/4 max-w-xs bg-neutral-900 rounded animate-pulse"></div></div><div className="w-9 h-5 md:w-10 md:h-6 bg-neutral-900 rounded-full animate-pulse shrink-0"></div></div><div className="flex items-center justify-between gap-4 p-4 md:p-5 bg-[#000000] border border-neutral-800 rounded-xl md:rounded-2xl"><div className="flex-1 space-y-2"><div className="h-3 w-32 bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-full max-w-sm bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-3/4 max-w-xs bg-neutral-900 rounded animate-pulse"></div></div><div className="w-9 h-5 md:w-10 md:h-6 bg-neutral-900 rounded-full animate-pulse shrink-0"></div></div></div></div>
        <div className="bg-[#000000] border border-neutral-800 rounded-2xl md:rounded-3xl p-5 md:p-8 shadow-sm"><div className="h-4 w-32 bg-neutral-900 rounded animate-pulse mb-5 md:mb-6"></div><div className="flex items-center justify-between gap-4 p-4 md:p-5 bg-[#000000] border border-neutral-800 rounded-xl md:rounded-2xl"><div className="flex-1 space-y-2"><div className="h-3 w-24 bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-full max-w-sm bg-neutral-900 rounded animate-pulse"></div><div className="h-2 w-3/4 max-w-xs bg-neutral-900 rounded animate-pulse"></div></div><div className="w-24 h-8 bg-neutral-900 rounded-lg animate-pulse shrink-0"></div></div></div>
      </div>
    )
  }
