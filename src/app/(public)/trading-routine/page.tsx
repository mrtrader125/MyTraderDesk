...
export default function TradingRoutinePage() {
  return (
    <main className="bg-[#050505] text-neutral-300 min-h-screen font-sans selection:bg-blue-900 selection:text-white pb-24">
      <article className="max-w-3xl mx-auto px-6 pt-24 md:pt-32">
        ...
        <header className="mb-16 border-b border-neutral-800 pb-10">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight text-white mb-6 leading-[1.1]">
        ...
        {/* DOCUMENT FOOTER / CTA */}
        <div className="mt-20 pt-10 border-t border-neutral-900 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
