...
export default function TradingRoutinePage() {
  return (
    <div className="bg-[#050505] text-neutral-300 min-h-screen font-sans selection:bg-blue-900 selection:text-white flex flex-col">
      ...
      <footer className="w-full border-t border-neutral-900/60 bg-[#050505] py-3 mt-auto">
        <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
          <div className="text-neutral-600 text-[9px] font-mono uppercase tracking-widest">
            © {new Date().getFullYear()} MyTraderDesk
          </div>
          
          <div className="flex gap-4 text-[9px] font-bold uppercase tracking-widest text-neutral-600">
